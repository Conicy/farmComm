...
REM == UNINSTALL PREVIOUS CONFIG--NECESSARY IF YOU'RE UPGRADING--REMOVES PREVIOUS SETUPS (EVEN IF SOME OF THEM WERE NEVER PUBLISHED ==
REG IMPORT noFarmComm.reg
SCHTASKS /DELETE /TN "killCheck"
SCHTASKS /DELETE /TN "runCheck"
SCHTASKS /DELETE /TN "userSpawn"

REM ============ SYSTEM INSTALL ============
REM REGKEY METHOD--SUSPENDED (PROBABLY DEPRECATED)!
